...
header = ["chrom.pos", "sample", "ref", "alt", "genotype", "DeNovo_LoH", "TiTv", "WhattoWhat", "MutantSample1","MutantSample2"]
header = '\t'.join(header)
print(header)    
popconclist = []
popaltlist = []
...
#         popdata_alt = split[4]
#         popconclist.append(popconcatenated)
#         popaltlist.append(popdata_alt)
#
#     popconc_and_popalt = zip(popconclist, popaltlist)
#
#     popdict= dict(popconc_and_popalt)    

    # if concatenated == popconcatenated:
    #         PopulationPoly = True

    
with open(datatable, "r") as mutations_table:
        ...
        for line in mutations_table:
            if line.startswith('chrom.pos'): #skips the header line
                ...
                samplenames = split[3:]
                    ...
                    PopulationPoly = "placeholder"
                    MutantSample = "placeholder"
                #
    ...
    #                     homo2het +=1
                    ...
                    if mingeno == geno_list[1]:
                        MutantSample1 = samplenames[1]
                        MutantSample2 = samplenames[2]
                        
                    else:
                        MutantSample1 = samplenames[4]
                        MutantSample2 = samplenames[5]
                                
                    #print(population_dictionary)    
                     #if concatenated in population_dictionary:
#                             popalt = popdict[concatenated]
#                             #print(alt)
#                             PopulationPoly = popalt
#                             #PopulationPoly == True
#                         else:
#                             PopulationPoly = "False"
                ...
                #
                                if meltconcatenated ==concatenated:
                                    ...
                                    outlist = [meltconcatenated, meltsample, ref, alt, meltgenotypes, DeNovo_or_LoH, TiTv, WhattoWhat, MutantSample1, MutantSample2]
...
#
#
#     somatic = definemutations(datatable, "SomaticMutation", (numberofparents+3), popdict)
#     if numberofsperm ==5:
#         uglm1 = definemutations(datatable, "UniqueGermlineMutation", (((numberofparents_numberofsperm)-1)+3), popdict)
#     else:
#         uglm1 = definemutations(datatable, "UniqueGermlineMutation", ((numberofparents+numberofsperm)+3), popdict)
    #
    ...
    # gglm = definemutations(datatable, "GlobalGermlineMutation", (numberofparents+4), popdict)
